    ...
    <div className='w-[500px] h-auto flex flex-col mx-auto my-5  justify-center gap-2 px-4 xxs:w-full md:w-[500px] '>
      ...
      <div className='flex flex-col gap-5'> 
        <div className="relative ">
            ...
            <input type="text" id="username" className="bg-white border-1 border-black text-gray-900  ring-1 ring-[#E0DEDE] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-white dark:border-white dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your user name"/>
          </div> 
          <div className="relative ">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5  pointer-events-none">
          ...
          <div className="relative ">
            ...
            <input type="password" id="password" className="bg-white border border-black > * text-gray-900 text-sm rounded-lg ring-1 ring-[#E0DEDE] focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-white dark:border-white dark:placeholder-gray-400 dark:text-black h- dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter your Password"/>
          </div>
          <div className="relative ">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none border-3 border-black">
              <svg className="w-6 h-6 text-[#C7C7C7] dark:text-[#C7C7C7]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
            ...
            <input type="password" id="confirmPassword" className="bg-white border border-black > * text-gray-900 text-sm rounded-lg ring-1 ring-[#E0DEDE] focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-white dark:border-white dark:placeholder-gray-400 dark:text-black h- dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Confirm your Password"/>
          </div>
          ...
          <button className='bg-red-500 text-lg text-white w-full py-2 rounded-lg hover:bg-red-400 '>Sign up</button>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <button type="button" className="text-black bg-white border-black ring-1 ring-[#E0DEDE]  border-3 w-full h-11 hover:bg-[#3b5998]/90 hover:text-white focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
        ...
        <button type="button" className="text-black ring-1 ring-[#E0DEDE] bg-white w-full h-11 hover:bg-[#4285F4]/90 hover:text-white focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
          <svg className="w-7 h-7 me-2" aria-hidden="true" fill="currentColor" viewBox="0 0 18 19">
