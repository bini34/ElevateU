...
export default function Signin() {
  ...
  return (
    <div className='w-[500px] flex flex-col mx-auto my-5 justify-center gap- px-5 xxs:w-full xxs:px-15 md:w-[500px]  '>
      ...
      <div className='flex flex-col gap-5'>  
          ...
          <button className='bg-red-500 text-lg text-white w-full py-2 rounded-lg hover:bg-red-400'>Sign In</button>
      </div>
