                    ...
                    {isMenuOpen && (
                       ...
                       <div className="p-2">
                           <button
                               onClick={() => {
                                   setIsMenuOpen(false);
                                   if (authUser?.user_name) router.push(`/${authUser.user_name}`);
                               }}
                               className="w-full text-left px-4 py-2 hover:bg-gray-50 rounded-lg flex items-center space-x-3 transition-colors duration-150"
                           >
