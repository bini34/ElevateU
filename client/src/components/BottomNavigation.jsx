...
const BottomNavigation = () => {
    ...
    const getNavItemClasses = (path) => {
        ...
        return `p-3 rounded-full ${isActive ? 'bg-red-600 text-white' : 'hover:bg-red-600 hover:text-white'}`;
    };

  return (
          <div className="flex  h-auto w-full justify-between border-solid rounded-full px-2 py-1 border-3 border-black mx-auto bg-white">
            ...
            <li className={getNavItemClasses('/create-post')}>
                <Link href="/create-post" aria-label="Create post">
                    <svg className="w-[36px] h-[36px] " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fillRule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4.243a1 1 0 1 0-2 0V11H7.757a1 1 0 1 0 0 2H11v3.243a1 1 0 1 0 2 0V13h3.243a1 1 0 1 0 0-2H13V7.757Z" clipRule="evenodd" />
                    </svg>
                </Link>
            </li>
            <li className={getNavItemClasses('/groups')}>
                <Link href="/groups" aria-label="Groups">
                    <svg className="w-[28px] h-[28px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
